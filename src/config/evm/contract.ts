import { getContract, createPublicClient, http, WalletClient, PublicClient } from 'viem';
...
export const token = (chainType: EVM, address: `0x{string}`, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: erc20Abi,
    address: address,
    client: options.wallet
  })
  return getContract({
    abi: erc20Abi,
    address: address,
...
export const client = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: clientAbi,
...
export const clientVault = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: clientVaultAbi,
...
export const clientMessage = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: messageAbi,
...
export const hub = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: hubAbi,
...
export const accountManager = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
...
export const assetManager = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: assetManagerAbi,
...
export const hubMessage = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: messageAbi,
...
export const pool = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: poolAbi,
...
export const priceOracle = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: priceOracleAbi,
...
export const rateModel = (chainType: EVM, options: EVMOptions = {}): any => {
  if (options.wallet) return getContract({
    abi: rateModelAbi,
